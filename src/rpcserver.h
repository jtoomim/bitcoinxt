...
extern json_spirit::Value getblocktemplate2(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value setblockmaxsize(const json_spirit::Array& params, bool fHelp);
